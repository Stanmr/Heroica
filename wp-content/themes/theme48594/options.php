...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '', 
				'image' => CHILD_URL .'/images/main_pattern.png', 
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '18px', 'lineheight' => '25px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#757575'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '71px', 'lineheight' => '65px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '62px', 'lineheight' => '55px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '35px', 'lineheight' => '35px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '26px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '24px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '70px', 'lineheight' => '70px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#f3cc52'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '15px', 'lineheight' => '20px', 'face' => 'Jockey One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#626262'));
